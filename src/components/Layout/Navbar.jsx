...
const Navbar = () => {
  ...
  return (
    <>
      <div className={`w-[378px] sm:w-[698px] md:w-[1336px] h-[80px] sm:h-[80px] md:h-[111px] mx-auto flex justify-around items-center ${isDarkMode ? "bg-[#161616]" : "bg-[#ffffff]"}  mt-[12px] border rounded-[20px]`}>
        <div className="w-[86px] h-[37px] md:w-[115px] md:h-[50px] logo">
          <img className="text-full md:" src={`/assets/images/${!isDarkMode ? "logo_dataways_dark.svg" : "logo_dataways_light.svg"}`} alt="Dataways.az" />
        </div>
        <nav>
